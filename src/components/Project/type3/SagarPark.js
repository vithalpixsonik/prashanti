        ...
        <div>
            <Header/>
                <section className="page-header">
                        <h1 className="text-white text-center">Sagar Park, Residential Building</h1>
                </section>
                <div className="container mt-5 mb-5">
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="pt-3">Sagar Park, Residential Building</h3><hr/>
                            <p className="pt-2"><b>Location :</b><br/> Ghatkopar, Mumbai, Maharastra, India</p>
                            <p className="pt-2"><b>Type :</b><br/>  built up area, B+G+13</p>
                            <p className="pt-2"><b>Size :</b><br/> 80000 sq.ft</p>
