...
const ChetanTarwaniOffice = () => {
    return (
        <div>
            <Header/>
            <section className="page-header">
                    <h1 className="text-white text-center">Chetan  Tarwani, Office</h1>
            </section>
            <div className="container mt-5 mb-5">
                ...
                <div className="row mt-3">
                    ...
                    <div className="col-lg-6">
                        ...
                        <h3 className="pt-3">Chetan  Tarwani, Office</h3><hr/>
                        <p className="pt-2"><b>Location :</b><br/> Raipur, India</p>
                        <p className="pt-2"><b>Type :</b><br/> - </p>
                        <p className="pt-2"><b>Size :</b><br/> 10,000 sq. ft. area </p>
...
export default ChetanTarwaniOffice
