    ...
    return (
        <div>
            ...
            <section className="page-header">
                    <h1 className="text-white text-center">MCGM Gymkhana</h1>
            </section>
            <div className="container mt-5 mb-5">
                ...
                <div className="row mt-3">
                    ...
                    <div className="col-lg-6">
                        ...
                        <h3 className="pt-3">MCGM Gymkhana</h3><hr/>
                        <p className="pt-2"><b>Location :</b><br/> Mumbai, Maharastra, India</p>
                        <p className="pt-2"><b>Type :</b><br/> built up area, G+1 storeys</p>
